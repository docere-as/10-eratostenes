...
programación concurrente. En ambas versiones seguiremos el paradigma
de programación funcional y, dentro de este paradigma, el estilo de
programación propio de elixir. Es decir, escribiremos _código
idiomático_ para elixir.
...
### Condidiciones para lograr los objetivos de aprendizaje
  ...
  - Seguir el paradigma de programación funcional y no hacer 
...
### Condidiciones para lograr los objetivos de aprendizaje
  ...
  - Implementar la arquitectura de procesos definida en el enunciado.
  
  - Comprender las dos alternativas: a) un proceso se comporta diferente
    según sea su estado, b) existen varios tipos de procesos.

  - Implementar una de las alternativas.
...
de la cola de filtros en distintos instantes de la ejecución:
